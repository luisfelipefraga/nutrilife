  ...
  return (
    <div className="container py-2">
      ...
      <p className="text-secondary mb-4">
        Pesquise alimentos e monte sua refeição. Todos os dados são locais — 
      ...
      <div className="mt-5">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h3 className="mb-0">
            Minha Refeição ({selectedAlimentos.length} {selectedAlimentos.length === 1 ? 'item' : 'itens'})
          </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center gap-2">
                      <input
                        type="number"
                        className={`form-control ${invalidInputs[item.id] ? 'border-danger' : ''}`}
                        value={item.gramas}
